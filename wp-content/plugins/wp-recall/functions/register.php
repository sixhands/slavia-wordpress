...
function rcl_password_regform( $content ) {
    ...
    if ( $difficulty == 1 ) {
        $content .= '<input class="input-modal text-center" placeholder="' . __( 'Password', 'wp-recall' ) . '" required id="primary-pass-user" type="password" onkeyup="passwordStrength(this.value)" value="' . $user_pass . '" name="user_pass">';
    } else {
        $content .= '<input class="input-modal text-center" placeholder="' . __( 'Password', 'wp-recall' ) . '" required type="password" value="' . $user_pass . '" id="primary-pass-user" name="user_pass">';
    }
...
function rcl_secondary_password( $fields ) {
    ...
    $fields .= ' <!--<div class="form-block-rcl default-field">-->
                    <input class="input-modal text-center" placeholder="' . __( 'Repeat the password', 'wp-recall' ) . '" required id="secondary-pass-user" type="password" value="' . (isset( $_REQUEST['user_secondary_pass'] ) ? $_REQUEST['user_secondary_pass'] : '') . '" name="user_secondary_pass">
