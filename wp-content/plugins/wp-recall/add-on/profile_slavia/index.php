...
function get_doc_fields($data)
{
    ...
    $input_doc_fields =
        array(
            ...
            'other_currency' => $request['output_currency'], //Противоположная валюта, для вывода стоимости данной валюты в других валютах (иной паевой взнос)
    ...
    if (!$is_deposit)
    {
        $output_doc_fields =
            array(
                ...
                'other_currency' => $request['input_currency'],
